...
| :--- | :---: | :--- | :--- | :--- |
| **2026-09-08** | **TTS 語音合成 (簡報版)** | **非紅產業鏈語音合成（TTS）研究成果報告（原語會簡報版）** | 專為原語會長官與同仁撰寫之簡報版。白話解析引進非紅大模型之戰略意義、四大工程、三大表現力（情緒、韻律語速、音效）實測結論與後續解方，保留完整圖表。 | [檢視報告 (Markdown)](reports/2026-09-08/tts_simplified_report.md) |
...
| **2026-09-08** | **ASR 語音辨識 (簡報版)** | **全族語語音辨識（ASR）模型成果報告（原語會簡報版）** | 專為原語會長官與同仁撰寫之簡報版。以白話解析模型訓練四大核心工程（語料整併、音訊預處理、Language Tag 身分證、獨立大考）、成績對比（平時與吵雜環境）與原因分析，保留完整圖表。 | [檢視報告 (Markdown)](reports/2026-09-08/asr_simplified_report.md) |
