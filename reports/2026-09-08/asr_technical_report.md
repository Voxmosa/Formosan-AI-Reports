...
xychart-beta
    ...
    y-axis "加權 CER (%)" 0 --> 10
    bar [4.36, 4.75, 4.54, 5.61, 3.33, 8.62, 4.73, 4.97]
    line [2.71, 4.41, 4.04, 4.88, 2.83, 7.58, 4.12, 3.97]
```

> **圖表說明**：柱狀圖（Bar）為「上一期 Baseline 模型」在 SNR 10dB 之加權 CER；折線（Line）為「本期新微調模型」在 SNR 10dB 之加權 CER。全體 8 大語群之折線皆落於柱狀之下，證實新模型全面優於上一期。
...
| **賽德克與太魯閣語群 (Seediq & Truku)** | 4 | 2,374 | 4.73% | **4.12%** | -0.61% | **+12.8%** | +1.69% |
...
| 賽德克與太魯閣語群 | `trv-x-td` | **都達賽德克語** | 519 | 3.73% | **3.41%** | -0.32% | +8.6% | +1.95% | 🔷 高強健 |
| 賽德克與太魯閣語群 | `trv-x-tgdy` | **德固達雅賽德克語** | 657 | 5.45% | **4.48%** | -0.97% | +17.8% | +2.16% | 🔷 高強健 |
| 賽德克與太魯閣語群 | `trv-x-trk` | **德鹿谷賽德克語** | 528 | 6.02% | **5.71%** | -0.31% | +5.1% | +1.43% | 🔶 中度強健 |
| 賽德克與太魯閣語群 | `trv-x-truku` | **太魯閣語** | 670 | 3.79% | **3.08%** | -0.71% | +18.7% | +1.22% | 🔷 高強健 |
